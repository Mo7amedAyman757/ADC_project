...
# 13 "ECU_Layer/7_segment/../../MCAL_Layer/GPIO/../std_types.h"
...
# 14 "ECU_Layer/7_segment/../../MCAL_Layer/GPIO/../std_types.h" 2
# 23 "ECU_Layer/7_segment/../../MCAL_Layer/GPIO/../std_types.h"
...
# 34 "ECU_Layer/7_segment/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum {
    GPIO_LOW,
    GPIO_HIGH
} logic_t;
...
STD_ReturnType seven_segment_write_number(const segment_t *segment, uint8 number) {
    ...
    if (((void*)0) == segment) {
        ...
        ret = gpio_pin_write_logic(&(segment->segment_pins[0]), (number >> 0) & 0x01);
