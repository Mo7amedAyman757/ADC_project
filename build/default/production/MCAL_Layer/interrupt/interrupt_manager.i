...
# 1 "MCAL_Layer/interrupt/interrrupt_manager.h" 1
# 12 "MCAL_Layer/interrupt/interrrupt_manager.h"
...
# 13 "MCAL_Layer/interrupt/../GPIO/../std_types.h"
...
# 12 "MCAL_Layer/interrupt/../GPIO/../std_libraries.h"
...
# 14 "MCAL_Layer/interrupt/../GPIO/../std_types.h" 2
...
# 12 "MCAL_Layer/interrupt/interrrupt_manager.h" 2
...
void __attribute__((picinterrupt(("")))) InterruptManager(void) {
    ...
    if ((INTCONbits.RBIE == 1) && (INTCONbits.RBIF == 1) && (IOCBbits.IOCB4 == 1) && (PORTBbits.RB4 == GPIO_HIGH)) {
        RB4_ISR(1);
    } else if ((INTCONbits.RBIE == 1) && (INTCONbits.RBIF == 1) && (IOCBbits.IOCB4 == 1) && (PORTBbits.RB4 == GPIO_LOW)) {
        RB4_ISR(0);
    } else {
