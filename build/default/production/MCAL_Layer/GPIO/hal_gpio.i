...
# 13 "MCAL_Layer/GPIO/../std_types.h"
...
# 14 "MCAL_Layer/GPIO/../std_types.h" 2
# 23 "MCAL_Layer/GPIO/../std_types.h"
...
STD_ReturnType gpio_pin_direction_status(const pin_config_t *pin_config, direction_t *direction_status) {
    STD_ReturnType ret = (STD_ReturnType)0x01;
    if ((((void*)0) == pin_config) || (pin_config->pin > 8 - 1) || (((void*)0) == direction_status)) {
        ret = (STD_ReturnType)0x00;
    } else {
...
STD_ReturnType gpio_pin_read_logic(const pin_config_t *pin_config, logic_t *logic_status) {
    STD_ReturnType ret = (STD_ReturnType)0x01;
    if ((((void*)0) == pin_config) || (pin_config->pin >= 8 - 1) || (((void*)0) == logic_status)) {
        ret = (STD_ReturnType)0x00;
    } else {
        *logic_status = ((*port_register[pin_config->port] >> pin_config->pin) & (uint8)1);
    }
    return ret;

}
# 114 "MCAL_Layer/GPIO/hal_gpio.c"
STD_ReturnType gpio_pin_toggle_logic(const pin_config_t *pin_config) {
    STD_ReturnType ret = (STD_ReturnType)0x01;
    if ((((void*)0) == pin_config) || (pin_config->pin > 8 - 1)) {
        ret = (STD_ReturnType)0x00;
    } else {
        (*port_register[pin_config->port] ^= (1 << pin_config->pin));
    }
    return ret;
