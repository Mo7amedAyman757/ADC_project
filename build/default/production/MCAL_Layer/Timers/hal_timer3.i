# 1 "MCAL_Layer/Timers/hal_timer3.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL_Layer/Timers/hal_timer3.c" 2
...
# 1 "MCAL_Layer/Timers/hal_timer3.h" 1
# 12 "MCAL_Layer/Timers/hal_timer3.h"
# 1 "MCAL_Layer/Timers/../GPIO/hal_gpio.h" 1
# 12 "MCAL_Layer/Timers/../GPIO/hal_gpio.h"
# 1 "MCAL_Layer/Timers/../GPIO/hal_gpio_cfg.h" 1
# 12 "MCAL_Layer/Timers/../GPIO/hal_gpio.h" 2


# 1 "MCAL_Layer/Timers/../GPIO/../std_types.h" 1
# 13 "MCAL_Layer/Timers/../GPIO/../std_types.h"
# 1 "MCAL_Layer/Timers/../GPIO/../compiler.h" 1
# 12 "MCAL_Layer/Timers/../GPIO/../compiler.h"
...
# 12 "MCAL_Layer/Timers/../GPIO/../compiler.h" 2
# 13 "MCAL_Layer/Timers/../GPIO/../std_types.h" 2

# 1 "MCAL_Layer/Timers/../GPIO/../std_libraries.h" 1
# 12 "MCAL_Layer/Timers/../GPIO/../std_libraries.h"
...
# 12 "MCAL_Layer/Timers/../GPIO/../std_libraries.h" 2
...
# 23 "MCAL_Layer/Timers/../GPIO/../std_types.h"
...
# 14 "MCAL_Layer/Timers/../GPIO/hal_gpio.h" 2

# 1 "MCAL_Layer/Timers/../GPIO/../device_config.h" 1
# 15 "MCAL_Layer/Timers/../GPIO/hal_gpio.h" 2
# 34 "MCAL_Layer/Timers/../GPIO/hal_gpio.h"
typedef enum {
    GPIO_LOW,
    GPIO_HIGH
} logic_t;
...
# 12 "MCAL_Layer/Timers/hal_timer3.h" 2

# 1 "MCAL_Layer/Timers/../interrupt/internal_interrupt.h" 1
# 11 "MCAL_Layer/Timers/../interrupt/internal_interrupt.h"
# 1 "MCAL_Layer/Timers/../interrupt/mcal_interrupt.h" 1
# 12 "MCAL_Layer/Timers/../interrupt/mcal_interrupt.h"
# 1 "MCAL_Layer/Timers/../interrupt/mcal_interrupt_cfg.h" 1
# 12 "MCAL_Layer/Timers/../interrupt/mcal_interrupt.h" 2
# 51 "MCAL_Layer/Timers/../interrupt/mcal_interrupt.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY,
    INTERRUPT_HIGH_PRIORITY
} priority_level_t;
# 11 "MCAL_Layer/Timers/../interrupt/internal_interrupt.h" 2
# 13 "MCAL_Layer/Timers/hal_timer3.h" 2
# 45 "MCAL_Layer/Timers/hal_timer3.h"
typedef enum {
...
# 8 "MCAL_Layer/Timers/hal_timer3.c" 2


void (* Timer3_InterruptHandler) (void) = ((void*)0);
...
# 25 "MCAL_Layer/Timers/hal_timer3.c"
STD_ReturnType Timer3_Init(const timer3_t *timer) {
    ...
    if (((void*)0) == timer) {
        ...
        (T3CONbits.T3CKPS = timer->timer3_prescaler);
        ...
        (PIE2bits.TMR3IE = 1);
        (PIR2bits.TMR3IF = 0);
# 57 "MCAL_Layer/Timers/hal_timer3.c"
        (INTCONbits.GIE = 1);
        (INTCONbits.PEIE = 1);
...
# 77 "MCAL_Layer/Timers/hal_timer3.c"
STD_ReturnType Timer3_DeInit(const timer3_t *timer) {
    STD_ReturnType ret = (STD_ReturnType)0x00;
    if (((void*)0) == timer) {
        ret = (STD_ReturnType)0x00;
...
# 102 "MCAL_Layer/Timers/hal_timer3.c"
STD_ReturnType Timer3_Write_value(const timer3_t *timer, uint16 value) {
    STD_ReturnType ret = (STD_ReturnType)0x00;
    if (((void*)0) == timer) {
        ret = (STD_ReturnType)0x00;
...
# 124 "MCAL_Layer/Timers/hal_timer3.c"
STD_ReturnType Timer3_Read_value(const timer3_t *timer, uint16 *value) {
    STD_ReturnType ret = (STD_ReturnType)0x00;
...
static STD_ReturnType Timer3_mode_config(const timer3_t * timer) {
    ...
    if (((void*)0) == timer) {
        ...
        if (timer->timer3_mode == 0) {
            (T3CONbits.TMR3CS = 0);
        } else if (timer->timer3_mode == 1) {
            (T3CONbits.TMR3CS = 1);
            if (timer->timer3_counter_cfg == 0) {
                (T3CONbits.T3SYNC = 0);
            } else if (timer->timer3_counter_cfg == 1) {
                (T3CONbits.T3SYNC = 1);
            } else {
            }
        } else {
...
static STD_ReturnType Timer3_reg_config(const timer3_t * timer) {
    ...
    if (((void*)0) == timer) {
        ...
        if (timer->timer3_reg == 0) {
            (T3CONbits.RD16 = 0);
        } else if (timer->timer3_reg == 1) {
            (T3CONbits.RD16 = 1);
        } else {
        }
    }
