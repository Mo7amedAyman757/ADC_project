# 1 "MCAL_Layer/Timers/hal_timer1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL_Layer/Timers/hal_timer1.c" 2
...
# 1 "MCAL_Layer/Timers/hal_timer1.h" 1
# 12 "MCAL_Layer/Timers/hal_timer1.h"
...
# 12 "MCAL_Layer/Timers/hal_timer1.h" 2
...
# 13 "MCAL_Layer/Timers/hal_timer1.h" 2
# 51 "MCAL_Layer/Timers/hal_timer1.h"
typedef enum {
...
# 8 "MCAL_Layer/Timers/hal_timer1.c" 2
...
# 27 "MCAL_Layer/Timers/hal_timer1.c"
STD_ReturnType timer1_init(const timer1_t *timer) {
    ...
    if (((void*)0) == timer) {
        ...
        (T1CONbits.T1CKPS = timer->timer1_prescaler);
        ...
        (PIE1bits.TMR1IE = 1);
        (PIR1bits.TMR1IF = 0);
# 59 "MCAL_Layer/Timers/hal_timer1.c"
        (INTCONbits.GIE = 1);
        (INTCONbits.PEIE = 1);
...
# 79 "MCAL_Layer/Timers/hal_timer1.c"
STD_ReturnType timer1_Deinit(const timer1_t * timer) {
    STD_ReturnType ret = (STD_ReturnType)0x00;
    if (((void*)0) == timer) {
        ret = (STD_ReturnType)0x00;
...
# 104 "MCAL_Layer/Timers/hal_timer1.c"
STD_ReturnType timer1_write_value(const timer1_t *timer, uint16 value) {
    STD_ReturnType ret = (STD_ReturnType)0x00;
    if (((void*)0) == timer) {
        ret = (STD_ReturnType)0x00;
...
# 126 "MCAL_Layer/Timers/hal_timer1.c"
STD_ReturnType timer1_read_value(const timer1_t *timer, uint16 * value) {
    STD_ReturnType ret = (STD_ReturnType)0x00;
...
static STD_ReturnType Timer1_mode_config(const timer1_t * timer) {
    ...
    if (((void*)0) == timer) {
        ...
        if (timer->timer1_mode == 0) {
            (T1CONbits.TMR1CS = 0);
        } else if (timer->timer1_mode == 1) {
            (T1CONbits.TMR1CS = 1);
            if (timer->timer1_counter_cfg == 0) {
                (T1CONbits.T1SYNC = 0);
            } else if (timer->timer1_counter_cfg == 1) {
                (T1CONbits.T1SYNC = 1);
            } else {
            }
        } else {
...
static STD_ReturnType Timer1_reg_config(const timer1_t * timer) {
    ...
    if (((void*)0) == timer) {
        ...
        if (timer->timer1_reg == 0) {
            (T1CONbits.RD16 = 0);
        } else if (timer->timer1_reg == 1) {
            (T1CONbits.RD16 = 1);
        } else {
        }
    }
