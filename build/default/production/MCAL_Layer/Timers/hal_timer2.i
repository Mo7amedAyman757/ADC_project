# 1 "MCAL_Layer/Timers/hal_timer2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL_Layer/Timers/hal_timer2.c" 2
...
# 1 "MCAL_Layer/Timers/hal_timer2.h" 1
# 12 "MCAL_Layer/Timers/hal_timer2.h"
...
# 12 "MCAL_Layer/Timers/hal_timer2.h" 2
...
# 13 "MCAL_Layer/Timers/hal_timer2.h" 2
# 49 "MCAL_Layer/Timers/hal_timer2.h"
typedef struct {
...
# 8 "MCAL_Layer/Timers/hal_timer2.c" 2
...
uint8 timer2_preload_val;
# 24 "MCAL_Layer/Timers/hal_timer2.c"
STD_ReturnType timer2_init(const timer2_t *timer) {
    ...
    if (((void*)0) == timer) {
        ...
        (T2CONbits.T2CKPS = timer->timer2_prescaler_val);

        (T2CONbits.T2OUTPS = timer->timer2_postscaler_val);
        ...
        (PIE1bits.TMR2IE = 1);
        (PIR1bits.TMR2IF = 0);
# 53 "MCAL_Layer/Timers/hal_timer2.c"
        (INTCONbits.GIE = 1);
        (INTCONbits.PEIE = 1);
...
# 73 "MCAL_Layer/Timers/hal_timer2.c"
STD_ReturnType timer2_Deinit(const timer2_t *timer) {
    STD_ReturnType ret = (STD_ReturnType)0x00;
    if (((void*)0) == timer) {
        ret = (STD_ReturnType)0x00;
...
# 98 "MCAL_Layer/Timers/hal_timer2.c"
STD_ReturnType timer2_write_value(const timer2_t *timer, uint8 value) {
    STD_ReturnType ret = (STD_ReturnType)0x00;
    if (((void*)0) == timer) {
        ret = (STD_ReturnType)0x00;
...
# 119 "MCAL_Layer/Timers/hal_timer2.c"
STD_ReturnType timer2_read_value(const timer2_t *timer, uint8 *value) {
    STD_ReturnType ret = (STD_ReturnType)0x00;
